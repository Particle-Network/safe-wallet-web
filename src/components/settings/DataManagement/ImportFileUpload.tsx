...
export const ImportFileUpload = ({
  ...
  return (
    <>
      <Typography>Import {'BTC Safe{Wallet}'} data by uploading a file in the area below.</Typography>
      ...
      <Typography>
        ...
        />
        Only JSON files exported from the {'BTC Safe{Wallet}'} can be imported.
      </Typography>
    </>
  )
}
